...
const CACHE_NAME = 'theo-ball-static-v11';
...
const ASSETS = [
  ...
  `${APP_PATH}/js/stats.js`,
  `${APP_PATH}/js/player.js`,
  `${APP_PATH}/js/player-facts.js`,
  `${APP_PATH}/js/venues.js`,
  // Icons
  `${APP_PATH}/icons/icon.png`,
  `${APP_PATH}/icons/flaming-baseball.png`,
